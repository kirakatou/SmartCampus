...
<div class="container-events" >
  ...
  <div class="events">
    ...
    <div class="overlay1" id="myEvent1">
    ...
    <div class="overlay1" id="myEvent2">
      <div class="col-md-2"></div>
      <div class="eventdetails col-md-8">
    ...
    <div class="overlay1" id="myEvent3">
      <div class="col-md-2"></div>
      <div class="eventdetails col-md-8">
        <a href="javascript:void(0)" class="closebtn glyphicon glyphicon-remove col-md-2 col-xs-12s" id="close" onclick="closeEvent()"></a>
        <img src="images/seminar/SAP.jpg" class="col-xs-12 col-sm-4 col-md-4">
      ...
      <div class="events-title col-xs-12 col-sm-12 col-md-12" id="events">
       ...
       <center>
        <div class="events-menu">
          <a onclick="openEvent1()"><div class="list col-xs-12 col-sm-4 col-md-4">
          ...
          <a onclick="openEvent2()"><div class="list col-xs-12 col-sm-4 col-md-4">
            <div class="list-content">
          ...
          <a onclick="openEvent3()"><div class="list col-xs-12 col-sm-4 col-md-4">
            <div class="list-content">
...
function openEvent1(){
    document.getElementById("myEvent1").style.height = "100%";
    document.getElementById("myEvent1").style.opacity = "1";
}
function openEvent2(){
    document.getElementById("myEvent2").style.height = "100%";
    document.getElementById("myEvent2").style.opacity = "1";
}
function openEvent3(){
    document.getElementById("myEvent3").style.height = "100%";
    document.getElementById("myEvent3").style.opacity = "1";
}

function closeEvent(){
    document.getElementById("myEvent1").style.height = "0%";
    document.getElementById("myEvent1").style.opacity = "0";
    document.getElementById("myEvent2").style.height = "0%";
    document.getElementById("myEvent2").style.opacity = "0";
    document.getElementById("myEvent3").style.height = "0%";
    document.getElementById("myEvent3").style.opacity = "0";
}
function closeNav() {
  if(mq.matches){
